...
export default function DemoPage() {
  ...
  const analyzeApplication = async () => {
    ...
    try {
      ...
      setAnalysis({
        score: 85,
        strengths: ['Strong technical background', 'Clear market opportunity', 'Innovative approach'],
        recommendations: ['Develop go-to-market strategy', 'Build advisory board', 'Create MVP prototype'],
        marketFit: 'yes',
        nextSteps: [
          'Complete profile assessment',
          'Schedule initial interview',
